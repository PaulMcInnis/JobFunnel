...
def parse_cli():
    """ Parse the command line arguments into an argv
    """

    parser = argparse.ArgumentParser(
        'JobFunnel CLI utility - https://github.com/PaulMcInnis/JobFunnel '
        '\nArguments passed here take precedence over YAML settings.')
    ...
    parser.add_argument('-o',
                        ...
                        help='Directory where the search results will be '
                             'stored. NOTE: You should have seperate '
                             'directories per-search!')
    ...
    parser.add_argument('-p',
                        ...
                        type=str,
                        required=False,
                        help='Province/State value for search region')

    parser.add_argument('--city',
                        dest='city',
                        type=str,
                        required=False,
                        help='City value for search region')

    parser.add_argument('--domain',
                        dest='domain',
                        type=str,
                        required=False,
                        help='Domain value for search region.')
    ...
    yaml = {
        ...
        'search_terms': {
            'region': {
                ...
                #'state': cli.state, FIXME: we need to validate for localization
                'city': cli.city,
                'domain': cli.domain
            },
