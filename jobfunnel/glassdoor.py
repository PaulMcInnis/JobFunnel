...
class GlassDoor(JobFunnel):
    ...
    def search_joblink_for_description(self, job):
        """function that scrapes the glassdoor job link for the description"""
        search = job['link']
    ...
    def get_description_with_delay(self, job, delay):
        """gets description from glassdoor job link and sets delays for requests"""
        sleep(delay)
    ...
    def scrape(self):
        ...
        # stores references to jobs in list to be used in description retrieval
