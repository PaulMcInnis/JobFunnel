...
RECENT_REGEX_A = re.compile(
    r"[tT]oday|[jJ]ust [pP]osted"
)
RECENT_REGEX_B = re.compile(
    r"[yY]esterday"
)
...
def calc_post_date_from_relative_str(
    ...
    try:
        ...
        try:
            ...
            # Months old
            try:
                months_ago = MONTH_REGEX.findall(
                    date_str
                )[
                    0
                ]
